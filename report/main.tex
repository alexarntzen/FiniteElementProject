...
\begin{proposition}
    ...
    \begin{equation*}
        \begin{aligned}
            ...
            \\
            l(v) &= \int_\Omega{\boldsymbol{v} \cdot  \boldsymbol{f}} \,dA  + \int_{\partial \Omega_N}{\boldsymbol{v}^\intercal \boldsymbol h} \,dS,
        \end{aligned}
    \end{equation*}
...
\begin{align}
    \int_\Omega{ \boldsymbol{\overline \epsilon}(\boldsymbol v)^\intercal C\boldsymbol{\overline \epsilon}(\boldsymbol u)} \,dA  &=\int_\Omega{\boldsymbol{v} \cdot  \boldsymbol{f}} \,dA + \int_{\partial \Omega}{\boldsymbol{v}^\intercal \boldsymbol{\sigma}}\boldsymbol{\hat{n} } \,dS  \\
    &= \int_\Omega{\boldsymbol{v} \cdot  \boldsymbol{f}} \,dA + \underbrace{\int_{\partial \Omega_D}{\boldsymbol{v}^\intercal \boldsymbol{\sigma}}\boldsymbol{\hat{n} } \,dS}_{= \ 0} + \int_{\partial \Omega_N}{\boldsymbol{v}^\intercal \boldsymbol h} \,dS,
\end{align}
...
\begin{proposition}
    ...
    where 
        ...
        b = [b_i] &= \int_\Omega \bm \varphi_i^T \bm f \, dA + \int_{\partial \Omega_N} \bm \varphi_i^T \bm h \, d\bm S,
        \end{align}
...
\begin{proof}
    ...
    $\bm v = \bm \varphi_j$ and $\bm u = \sum_i u_i \bm \varphi_i, u_i \in \mathbb{R}$. As $\bar \epsilon( \cdot )$ is linear we get  
    ...
    \begin{align*}
        ...
        &= \sum_i u_i a(\bm \varphi_i,\bm \varphi_j) \\
        &= \bm A \bm u
    \end{align*}

    where $\bm u = [u_1,u_2,\cdots,u_n]$, finally we have the linear form

    \begin{align*}
            l(v)&= \int_\Omega{\boldsymbol{v} \cdot  \boldsymbol{f}} \,dA + \int_{\partial \Omega_N}{\boldsymbol{v}^\intercal \boldsymbol h} \,dS \\
            &= \int_\Omega{\boldsymbol{\varphi_i}^T  \boldsymbol{f}} \,dA + \int_{\partial \Omega_N}{\boldsymbol{\varphi_i}^\intercal \boldsymbol h} \,dS \\
            &= \bm b,
    \end{align*}
\end{proof}
