...
TODO: Discuss: 1) numerical solution, 2) recovered stress, 3) convergence approximation using fine mesh, 4) ways to optimize the code.
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.5\textwidth}
        \centering
            ...
            \caption{Recovered stress $\sigma_{xx}$.}
        \label{solution-error-dirichlet-elastic-y}
    \end{subfigure}
    \label{plot-elasticity}
